...
<footer class="bg-white border-t border-gray-100 pt-20 pb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div class="space-y-6">
                ...
                <p class="text-gray-500 leading-relaxed text-sm">
                    VisionPro LCD Refurbishing Inc. is Brampton's leading wholesaler for high-quality mobile phone parts and professional repair tools.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex gap-3">
                        ...
                        <span class="text-gray-500 text-sm">14 Automatic Rd., Brampton#34, L6s5n5, Ontario</span>
                    </li>
                    <li class="flex gap-3">
                    ...
                    <li class="flex gap-3">
                        ...
                        <span class="text-gray-500 text-sm">info@visionprolcd.com</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="chat-widget" class="fixed bottom-24 right-6 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 hidden z-50 flex flex-col overflow-hidden transition-all duration-300">
        <div class="bg-gradient-to-br from-primary-500 to-primary-700 p-4 flex justify-between items-center text-white">
            ...
            <div class="flex gap-2">
                <a href="mailto:info@visionprolcd.com" title="Send Email" class="hover:bg-white/20 p-1 rounded-lg transition-colors flex items-center justify-center">
