                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <div class="w-full px-6 py-10 border-2 border-dashed border-gray-200 rounded-[2rem] flex flex-col items-center justify-center gap-3 group-hover:bg-gray-50 group-hover:border-primary-300 transition-all">
                                ...
                                <span class="text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">Select main image<br>Allowed: <span class="text-primary-600">JPG, PNG, WEBP</span> (Max 5MB)</span>
                            </div>
                            </div>
                        </div>
