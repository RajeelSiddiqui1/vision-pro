                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            ...
                            <td class="p-4">
                                <a href="admin-device-category-edit.php?id=<?= $category_id ?>&delete_sub=<?= $sub['id'] ?>" class="text-red-600 font-bold hover:underline" onclick="smartDelete(this, 'Purge Device Type', 'Are you sure you want to permanently remove this device classification? This action will immediately update the registry.')">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
